...
class ExtendedGaiaDR3TICInteractSkyCatalogProvider(GaiaDR3TICInteractSkyCatalogProvider):
    ...
    def get_detail_view(self, data: dict) -> Tuple[dict, list]:
        ...
        gaia_dispersions_url = f"https://{vizier_server}/viz-bin/VizieR-4?-out.add=_r&%2F%2Foutaddvalue=default&-sort=_r&-order=I&-c={coordStrEncoded}&-c.eq=J2000&-c.r=+30&-c.u=arcsec&-c.geom=r&-source=&-out.src=J%2FA%2BA%2F677%2FA137%2Fcatalog&-source=J%2FA%2BA%2F677%2FA137%2Fcatalog&-bmark=GET"
